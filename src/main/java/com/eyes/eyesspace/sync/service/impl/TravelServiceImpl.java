...
public class TravelServiceImpl implements TravelService {
    ...
    public TravelServiceImpl(TrackMapper trackMapper, ContextMapper contextMapper, TravelMapper travelMapper, CommentService commentService) {
    ...
    public FileUploadVO uploadTravelPic(MultipartFile multipartFile) throws CustomException {
        ...
        String url = FileUtils.sUpload(multipartFile, travelPath);
        // 记录文件上传日志
